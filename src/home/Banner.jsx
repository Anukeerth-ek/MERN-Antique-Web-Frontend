                              ...
                              {bannerSection?.map((item, index) => (
                                   <Link to={`/all-arts/${item.title}`}  key={index}>
                                        ...
                                        >
                                             <img
                                                  src={item?.image}
                                                  className="rounded-[70%] object-cover h-[120px] md:h-[110px] w-[120px] md:w-[110px] mx-auto group-hover:border-[4px]  group-hover:p-1 group-hover:border-blue-500  group-hover:duration-300"
                                             />
